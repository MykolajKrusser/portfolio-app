...
import classes from './BackgroundHome.css';
...
var ctxfr = this.ref.canvas.getContext('2d');
var ctxbg = this.refb.canvas.getContext('2d');
...
window.requestAnimationFrame(draw);
 ...
 init();
    ...
    render() {
        return (
            <div>
                <canvas ref="canvas" className={classes.Canvas} width={1950} height={800}></canvas>
                <canvas refb="canvasbg" className={classes.Canvasbg} width={1950} height={800}></canvas>
            </div>
        );
    }
}
